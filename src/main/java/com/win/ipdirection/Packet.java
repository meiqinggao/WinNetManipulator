...
import com.win.ipdirection.headers.*;
...
public class Packet {
    ...
    public Packet(byte[] raw, WinDivertAddress addr) {
        this(raw, new int[]{addr.IfIdx.intValue(), addr.SubIfIdx.intValue()},
                Enums.Direction.fromValue(addr.Direction.intValue()));
    }
    ...
    public boolean isOutbound() {
        return direction == Enums.Direction.OUTBOUND;
    }
    ...
    public boolean isInbound() {
        return direction == Enums.Direction.INBOUND;
    }
